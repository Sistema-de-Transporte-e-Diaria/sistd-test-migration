                            ...
                            <table class="table">
                                ...
                                <td>
                                    ...
                                    <select name="setEscolhaMotorista" style="height: 30px;width: 400px"readonly="true" >
                                        <option value="<?= $registro['setCodHE'] ?>"><?= $registro['motorista'] ?></option>
                                ...
                                <td>
                                    ...
                                    <select type="text" id="mes" name="mes"  disabled="true">
                                        <option style="color: #600" value="<?= $registro["mesHoraExtra"] ?>">
                                                <?= $registro["mesHoraExtra"] ?></option>
