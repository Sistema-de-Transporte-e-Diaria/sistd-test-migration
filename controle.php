      ...
      <div class="panel-body">
        ...
        <form  method="post" action="controlando.php" name="controle" onsubmit="return validaCampos();">
          <table class="table">
            <tr>
              <td>
                <div><label for="nSolicitacao">Solicitação Nº</label></div>
              ...
              <td>
                <div><label for="Motorista">Motorista</label></div>
                <select name="setMotorista" id="escolhaMotorista" required="true" style="width: 300px">
                  <?php
                  conecta();
                  // Verifia os status da solicitação
                  $sqlConsultaStatus1 = "SELECT * FROM solicitacao WHERE codSolicitacao = '$codSolicitado'";
                  $resultadoConsultaStatus1 = mysql_query($sqlConsultaStatus1) or
                    die("Houve um erro na gravação dos dados - CONSULTAR REGISTRO");
                  ...
                  if ($y == 2) {
                    ...
                    $pesquisa = " SELECT * FROM listarcontrole WHERE codSolicitacaoControle = '$codSolicitado'";
                    $resultado = mysql_query($pesquisa) or
                    ...
                    $pesquisa = "SELECT * FROM motoristas
                      WHERE statusMotorista = '1'"; /* AND codMotorista NOT IN
                        (SELECT codMotorista FROM listarsolicitacaocontrole
                          WHERE statusSolicitacao = '2' AND
                          (dtSaida BETWEEN '$dataSaida' AND '$dataRetorno' OR
                            dtRetorno BETWEEN '$dataSaida' AND '$dataRetorno') AND
                          (hrSaida BETWEEN '$horaSaida' AND '$horaRetorno' OR
                            hrRetorno BETWEEN '$horaSaida' AND '$horaRetorno'))"; */
                    $resultado = mysql_query($pesquisa) or
                      die("Não foi possível realizar a consulta ao banco de dados");
                    while ($registro = mysql_fetch_array($resultado)) {
                      ?>
              ...
              <td>
                <div><label for="Veiculo">Veículo</label></div>
                ...
                <?php
                  ...
                  $resultadoConsultaStatus2 = mysql_query($sqlConsultaStatus2) or
                    die("Houve um erro na gravação dos dados - CONSULTAR REGISTRO");
              ...
              <td>
                <div><label for="Diaria">Diária(as)</label></div>
                ...
                <?php
                  ...
                  $sqlConsultaStatus = "SELECT statusSolicitacao FROM solicitacao
                    WHERE codSolicitacao = '$codSolicitado'";
                  $resultadoConsultaStatus = mysql_query($sqlConsultaStatus) or
                    die("Houve um erro na gravação dos dados - CONSULTAR REGISTRO");
              ...
              <td>
                ...
                if ($y == 2) {
                  $sqlDisplay = "SELECT * FROM listarcontrole
                    WHERE codSolicitacaoControle = '$codSolicitado'";
                  $resultadoDisplay = mysql_query($sqlDisplay) or
                    die("Não foi possível realizar a consulta ao banco de dados");
                      ...
                      <tr>
                        <td>
                          ...
                          <input style="color: brown" type="text"
                            ...
                            value="<?= $registroDisplay["placa"] ?>">
                        </td>
                        <td>
                          <div><label for="Capacidade">Capacidade</label></div>
                          <input style="color: brown" type="text"
                            name="displayCapacidade" readonly="true" style="height:50px"
                            value="<?= $registroDisplay["ocupacao"] ?>">
                        </td>
                      </tr>
                    </table>
                  <?php
              ...
              <tr>
                <td>
                  ...
                  $sqlQtdPassageiros = "SELECT * FROM solicitacao
                    WHERE codSolicitacao = '$codSolicitado'";
                  $resultadoSqlQtdPassageiros = mysql_query($sqlQtdPassageiros) or
                    die("Não foi possível realizar a consulta ao banco de dados");
          ...
          <legend id="legendDadosRe" class="panel panel-success" style="background-color: #C1FFC1">
            Dados Realizados da Viagem
          </legend>
          ...
          <table id="tableDadosRe" class="table">
            <tr>
              ...
              <td>
                <div><label for=" Plantonista"> Plantonista</label></div>
              </td>
            </tr>
            
            <tr>
              <td>
                <div><label for="Saida">Saída</label></div>
              </td>
              <td>
              ...
              <td>
                <input type="text" name="setPlantonistaSaida" style="height:30px;width: 400px"/>
              </td>
            </tr>
                              
            <tr>
              <td>
                <div><label for="Retorno">Retorno</label></div>
              </td>
              <td>
              ...
              <td>
                <input type="text" name="setHrRetorno"class="form-control"
                  maxlength="5" placeholder="00:00" class="hora"style="height:30px;width: 100px"/>
              </td>
              <td>
                <input type="text" name="setPlantonistaRetorno" style="height:30px;width: 400px"/>
              </td>
            </tr>
          ...
          <table class="table">
            <tr>
              <td>
                <div>
                  <label style="background-color:#d6e9c6 "for="Combustivel">Combustível</label>
                </div>
              </td>
            </tr>
          </table>
          ...
          <table class="table">
            <tr>
              <td>
                <input type="radio" name="setCombus" value="reserva"class="form-group pull-right">
              </td>
              <td>
                <div><label>Reserva</label></div>
              </td>
              <td>
                <input type="radio" name="setCombus" value="um_quarto"class="form-group pull-right">
              </td>
              <td>
                <div><label>1/4</label></div>
              </td>
              <td>
                <input type="radio" name="setCombus" value="um_meio"class="form-group pull-right">
              </td>
              <td>
                <div><label>1/2</label></div>
              </td>
              <td>
                <input type="radio" name="setCombus" value="tres_quarto"class="form-group pull-right">
              </td>
              <td>
                <div><label>3/4</label></div>
              </td>
              <td>
                <input type="radio" name="setCombus" value="cheio"class="form-group pull-right">
              </td>
              <td>
                <div><label>Cheio</label></div>
              </td>
            </tr>
          </table>

          <legend id="legendDadosEvento" class="panel panel-success" style="background-color: #C1FFC1">
            Deslocamento Fora da Rota
          </legend>
          
          <table class="table">
            <tr>
              <td><div><label for="Km1">Km</label></div>
              <td><div><label for="Hora1">Hora</label></div>
              <td><div><label for="Deslocamento">Deslocamento</label></div>
              <td><div><label for="Finalidade">Finalidade</label></div>
              <td><div><label for="Solicitante">Solicitante</label></div>
            </tr>
            
            <tr>
              <td><input type="text" name="setKmForaRota1"style="height:30px;width: 100px"/></td>
              <td><input type="text" name="setHrForaRota1"class="form-control" maxlength="5" placeholder="00:00"
                style="height:30px;width: 100px"/></td>
              <td><input type="text" name="setDeslocForaRota1"style="height:30px" /></td>
              <td><input type="text" name="setFinaleForaRota1" style="height:30px"/></td>
              <td><input type="text" name="setSoliciForaRota1" style="height:30px;width: 400px"/></td>
            </tr>
            <tr>
              <td><input type="text" name="setKmForaRota2"style="height:30px;width: 100px"/></td>
              <td><input type="text" name="setHrForaRota2" class="form-control" maxlength="5" placeholder="00:00"
                style="height:30px;width: 100px"/></td>
              <td><input type="text" name="setDeslocForaRota2" style="height:30px"/></td>
              <td><input type="text" name="setFinaleForaRota2" style="height:30px"/></td>
              <td><input type="text" name="setSoliciForaRota2"style="height:30px;width: 400px"/></td>
            </tr>
            <tr>
              <td><input type="text" name="setKmForaRota3" style="height:30px;width: 100px"/></td>
              <td><input type="text" name="setHrForaRota3" class="form-control" maxlength="5" placeholder="00:00"
                style="height:30px;width: 100px"/></td>
              <td><input type="text" name="setDeslocForaRota3" style="height:30px"/></td>
              <td><input type="text" name="setFinaleForaRota3"style="height:30px"/></td>
              <td><input type="text" name="setSoliciForaRota3" style="height:30px;width: 400px"/></td>
            </tr>
            <tr>
              <td><input type="text" name="setKmForaRota4"style="height:30px;width: 100px" /></td>
              <td><input type="text" name="setHrForaRota4"class="form-control" maxlength="5" placeholder="00:00"
                style="height:30px;width: 100px"/></td>
              <td><input type="text" name="setDeslocForaRota4" style="height:30px"/></td>
              <td><input type="text" name="setFinaleForaRota4" style="height:30px"/></td>
              <td><input type="text" name="setSoliciForaRota4"style="height:30px;width: 400px"/></td>
            </tr>
            <tr>
              <td><input type="text" name="setKmForaRota5"style="height:30px;width: 100px" /></td>
              <td><input type="text" name="setHrForaRota5"  class="form-control" maxlength="5" placeholder="00:00"
                style="height:30px;width: 100px"/></td>
              <td><input type="text" name="setDeslocForaRota5"style="height:30px" /></td>
              <td><input type="text" name="setFinaleForaRota5" style="height:30px"/></td>
              <td><input type="text" name="setSoliciForaRota5" style="height:30px;width: 400px"/></td>
            </tr>
            <tr>
              <td><input type="text" name="setKmForaRota6"style="height:30px;width: 100px" /></td>
              <td><input type="text" name="setHrForaRota6"  class="form-control" maxlength="5" placeholder="00:00"
                style="height:30px;width: 100px"/></td>
              <td><input type="text" name="setDeslocForaRota6"style="height:30px" /></td>
              <td><input type="text" name="setFinaleForaRota6"style="height:30px"/></td>
              <td><input type="text" name="setSoliciForaRota6"style="height:30px;width: 400px" /></td>
            </tr>
            
            <tr>
              <td colspan="5">
                <div ><label for="Ocorrencia">Ocorrência</label></div>
