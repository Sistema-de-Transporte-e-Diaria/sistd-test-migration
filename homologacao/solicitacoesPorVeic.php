        ...
        <div  class="container-fluid">    
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title" >Relátorio de Solicitações por Veículo</h3>
                </div>
                <div class="panel-body "> 
                    <form  method="post" action="relatorios/relSolicitacoesVeic.php"target="_blank">  

                        <legend id="legendDadosPessoais" class="panel panel-success" 
                                style="background-color: #C1FFC1 "> Relatório com Filtro de Veículo</legend> 
                        ...
                        <table class="table">
                            ...
                            <tr>                                
                                <td>
                                    <div>
                                        <label for="SelecioneVeiculo"style="background-color: #d6e9c6">
                                            Selecione o Veículo
                                        </label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <select name="setEscolhaVeiculo" style="width: 300px">
                                        <option> </option>
                                        <?php
                                        conecta();
                                        // Recebe todos os campos da tabela controle do registro de código da variável $codSolicitado             
                                        $pesquisa2 = "SELECT * FROM veiculos
                                             WHERE statusVeiculo = '1'
                                       ORDER BY modelo;";
                                        $resultado2 = mysql_query($pesquisa2) or die("Não foi possível realizar a consulta ao banco de dados");
                                        While ($registro2 = mysql_fetch_array($resultado2)) {
                                            ?>       
                                            <option ><?= $registro2['modelo'] ?></option>
                                            <?php
                                        }
                                        ?> 
                                    </select>
