...
<html> 
    ...
    <!-- Inicia a tag body carregando a função totalAbast() -->

    <body onload="totalAbast()"style="font-family: courier">  
        <div  class="container-fluid">    
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title" >Editar Abastecimento</h3>
                </div>
                <div class="panel-body "> 
                    <?php
                    $codAbastecimentoEditar = $_GET['id'];
                    conecta();
                    // Seleciona o registro do abastecimento a ser editado
                    $pesquisa1 = "SELECT * FROM listarabastecimento
                         WHERE codAbastecimento='$codAbastecimentoEditar'";
                    ...
                    While ($registro = mysql_fetch_array($resultado1)) {
                        ?> 
                        <form  method="post" action="editandoAbast.php" name="abastecimento"> 
                            <table class="table">
                                <tr>
                                    <td > 
                                        <div >
                                        ...
                                        <input style="color: brown;height: 20px; width: 50px" type="text"
                                               name="codAbastecimento"
                                               readonly="true" value="<?= $registro["codAbastecimento"] ?>">
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <select name="setVeiculo" id="veiculo"
                                                required="true" style="height: 30px;width: 300px">
                                            <option style="color:#600"value="<?= $registro['idVeiculo'] ?> ">
                                                <?= $registro['modelo'] ?> - <?= $registro1['placa'] ?></option>
                                            <?php
                                            conecta();
                                    ...
                                    <td  >
                                        ...
                                        <select name="setMotorista" id="veiculo" required="true"
                                                onchange="indiceMotorista()"
                                                style="width: 350px;height: 30px">
                                            <option style="color:#600" value="<?= $registro['idMotorista'] ?> ">
                                            ...
                                            While ($registro2 = mysql_fetch_array($resultado)) {
                                                ?>       
                                                <option value="<?= $registro2['codMotorista'] ?>">
                                                    <?= $registro2['motorista'] ?></option>
                                            <?php } ?> 
                                        </select>
                                    </td> 
                                    ...
                                    <td>
                                        ...
                                        <input type="text" id="calendario" 
                                               value="<?= formatoData($registro["dtAbastecimento"]) ?>"
                                               name="setDtAbastecimento" style="height: 30px" required="true"/>                             
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" name="setVlrLitro" 
                                               class="real" id="vlrLitro"placeholder="00.00"
                                               required="true"style="height: 30px"
                                               value="<?= $registro["vlrLitro"] ?>" >
                                    </td>
                                    ...
                                    <td >
                                        ...
                                        <input  type="text" name="setQtd" id="qtd"value="<?= $registro["qtd"] ?>"
                                                required="true"style="height: 30px" >
                                    </td>
                                ...
                                <tr>   
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="setKmAtual" id="kmAtual"value="<?= $registro["kmAtual"] ?>"
                                               style="height: 30px" required="true">
                                    </td>
                                </tr>
                            </table>
