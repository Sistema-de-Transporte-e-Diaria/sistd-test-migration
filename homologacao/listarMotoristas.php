        ...
        <div id="main" class="container-fluid">
            <div id="top" class="row">
                ...
                <div class="col-md-3" style="left: 45%">
                    <a href="motoristas.php" class="btn btn-primary pull-right h2">Novo Motorista</a>
                </div>
            </div>
                    ...
                    <table class="table table-striped" cellspacing="0" cellpadding="0" id="tabela">                      
                        <thead>  
                            <tr>
                                ...
                                <th style="width: 15%">Saldo de Horas</th>
                                <th style="width: 10%" >CNH-Categoria</th>
                                <th style="width: 15%" >CNH-Número</th>
                                <th style="width: 15%">CNH-Validade</th>
                            ...
                            While ($registro = mysql_fetch_array($resultado)) {
                                ...
                                <tr >
                                    <td ><?= $registro["motorista"] ?></td>
                                     <td ><?= $registro["saldoHoras"] ?></td>
                                    <td ><?= $registro["cnhCategoria"] ?></td> 
                                    <td ><?= $registro["cnhNumero"] ?></td> 
                                    <td ><?= formatoData($registro["cnhValidade"]) ?></td>   
                                    <td  class="actions">                                                                                                                              
                                        <a class="btn btn-warning btn-small"   href=editarMotorista.php?id=<?= $registro["codMotorista"] ?>  
                                           title="Editar"><img src="imagens/editar.png"></a>                                            
                                        <a class="btn btn-danger btn-small"  href=excluirMotorista.php?id=<?= $registro["codMotorista"] ?>
