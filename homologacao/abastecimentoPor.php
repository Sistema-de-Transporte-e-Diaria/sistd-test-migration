        ...
        <div  class="container-fluid">    
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title" >Relátorio de Abastecimentos</h3>
                </div>
                <div class="panel-body ">
                    <form method="post" action="relatorios/relAbastecimentoPor.php" target="_blank">
                        <legend id="legendDadosPessoais" class="panel panel-success" 
                                style="background-color: #C1FFC1 "> Relatório com Filtros</legend> 
                        <table class="table">
                            <tr>
                                <td>
                                    <div>
                                    ...
                                    <select name="setEscolhaMotorista" style="width: 500px">
                                       ...
                                       ORDER BY motorista;";
                                        ...
                                        While ($registro1 = mysql_fetch_array($resultado1)) {
                                            ?>       
                                            <option value="<?= $registro1['codMotorista'] ?>"><?= $registro1['motorista'] ?></option>
                                            <?php
                                        }
                                        ?> 
                                    </select>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td>
                                    <select name="setEscolhaVeiculo" style="width: 500px">
                                        <option> </option>
                                        <?php
                                        conecta();
                                        // Recebe todos os campos da tabela controle do registro de código da variável $codSolicitado             
