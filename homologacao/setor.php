        ...
        <div  class="container-fluid">    
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title" >Cadastro de Setor</h3>
                </div>
                <div class="panel-body "> 
                    <form method="post" action="cadSetor.php" name="solicita" id="formSetor">
                        <table class="table">
                            <tr >
                                ...
                                <td>
                                    ...
                                    <input type="text" name="setDescricaoSetor" id="nome"
