                ...
                <table class="table table-striped" cellspacing="0" cellpadding="0" id="tabela">
                    ...
                    <tbody>
                        ...
                        $pesquisa = "SELECT * FROM listarbancohoras
                           ...
                           AND horaExtra <> '00:00:00'";
                        gravaLog("Listou banco de horas");
                        ...
                        While ($registro = mysql_fetch_array($resultado)) {
                            ...
                            <tr >
                                ...
                                <td ><?= $registro["horaExtra"] ?></td> 
                                <td ><?= formatoData($registro["dataFolga"]) ?></td>
                                <td ><?= $registro["justificativa"] ?></td> 
                                <td class="actions">                                
                                    <a class="btn  btn-small btn-primary"  title="Imprimir" 
                                       href=pdfBancoHorasReimprime.php?id=<?= $registro["codHoraExtra"] ?>><img src="imagens/imprimir.png"></a>  
                                    <a class="btn btn-danger btn-small"  href=excluirHoraExtra.php?id=<?= $registro["codHoraExtra"] ?>
