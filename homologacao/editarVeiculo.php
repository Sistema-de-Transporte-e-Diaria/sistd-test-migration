        ...
        <div  class="container-fluid">    
            <div class="panel panel-success">
                ...
                <div class="panel-body ">
                    <form method="post" action="editandoVeiculo.php" name="veiculo">    
                            <table class="table"> 
                                <tr>
                                     <td > 
                                        <div >
                            ...
                            <select name="setMarca" id="escolhaMarca" required="true">
                                       <option style="color: #860000" value="<?= $registro['marca'] ?>"><?= $registro["nomeMarca"] ?></option>
                                        <?php
                                        //Capitura o usuário logado para preencher os campos setor.
                                        conecta();
                                        $pesquisaMarca = "SELECT * FROM marcas 
                                         WHERE statusMarca <> 0 
                                         ORDER BY nomeMarca";
                                        $resultadoMarca = mysql_query($pesquisaMarca) or die("Não foi possível realizar a consulta ao banco de dados");
                                        While ($registroMarca = mysql_fetch_array($resultadoMarca)) {
                                            ?>       
                                            <option value="<?= $registroMarca['idMarca'] ?>"><?= $registroMarca["nomeMarca"] ?></option>
                                        <?php } ?>	
                                    </select>
                                  </td> 
                                ...
                                <td>
                                    ...
                                    <input type="text" name="setModelo" style="height: 30px"value="<?= $registro["modelo"] ?>"
                                ...
                                <td>
                                    ...
                                    <input type="text" name="setPlaca" value="<?= $registro["placa"] ?>"
                                           class="placa"placeholder="aaa-0000" 
                                ...
                                <td >
                                    ...
                                    <input type="text" name="setOcupacao" maxlength="3"value="<?= $registro["ocupacao"] ?>"
                        ...
                        <table class="table">
                            ...
                            <tr>                   
                                <td>
                                    ...
                                    <input type="text" id="calendario" value="<?= formatoData($registro["validadeExtintor"]) ?>"
                                ...
                                <td >
                                    ...
                                    <input  type="text"  name="setKmAtual"
                                ...
                                <td>
                                    ...
                                    <input  type="text" name="setTrocaOleo"
                            ...
                            <tr>
                                <td >
                                    ...
                                    <input  type="text" name="setTrocaFiltroOleo"
                                ...
                                <td >
                                    ...
                                    <input  type="text" name="setTrocaFiltroAR"
                                ...
                                <td >
                                    ...
                                    <input  type="text" name="setTrocaFiltroCombus" 
