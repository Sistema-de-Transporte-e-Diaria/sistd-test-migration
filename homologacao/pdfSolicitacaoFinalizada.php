...
conecta();
if (!empty($_POST[setEscolhaSolicitacao])) {
    $parametro = $_POST[setEscolhaSolicitacao];
} else {
    $parametro = $_POST[setCodSolicitacao];
}

$sqlPdf = "SELECT * FROM listarsolicitacaocontrole WHERE codSolicitacao = '$parametro'";
...
While ($registroPdf = mysql_fetch_array($resultadoPdf)) {
    ...
    $motorista = $registroPdf['motorista'];
    $placaveiculo = $registroPdf ['placa'];
    $kmsaida = $registroPdf['kmSaidaControle'];
    $realdtsaida = $registroPdf['dtSaidaControle'];
    $realhrsaida = $registroPdf['hrSaidaControle'];
    $plantonistasaida = $registroPdf['plantonistaSaida'];
    $kmretorno = $registroPdf['kmRetornoControle'];
    $realdtretorno = $registroPdf['dtRetornoControle'];
    $realhrretorno = $registroPdf['hrRetornoControle'];
    $plantonistaretorno = $registroPdf['plantonistaRetorno'];
    $combustivel = $registroPdf['combustivel'];
    $fr01km = $registroPdf['kmForaRota1'];
    $fr01hora = $registroPdf['hrForaRota1'];
    $fr01deslocamento = $registroPdf['deslocForaRota1'];
    $fr01finalidade = $registroPdf['finalidadeForaRota1'];
    $fr01solicitante = $registroPdf['solicitanteForaRota1'];
    $fr02km = $registroPdf['kmForaRota2'];
    $fr02hora = $registroPdf['hrForaRota2'];
    $fr02deslocamento = $registroPdf['deslocForaRota2'];
    $fr02finalidade = $registroPdf['finalidadeForaRota2'];
    $fr02solicitante = $registroPdf['solicitanteForaRota2'];
    $fr03km = $registroPdf['kmForaRota3'];
    $fr03hora = $registroPdf['hrForaRota3'];
    $fr03deslocamento = $registroPdf['deslocForaRota3'];
    $fr03finalidade = $registroPdf['finalidadeForaRota3'];
    $fr03solicitante = $registroPdf['solicitanteForaRota3'];
    $fr04km = $registroPdf['kmForaRota4'];
    $fr04hora = $registroPdf['hrForaRota4'];
    $fr04deslocamento = $registroPdf['deslocForaRota4'];
    $fr04finalidade = $registroPdf['finalidadeForaRota4'];
    $fr04solicitante = $registroPdf['solicitanteForaRota4'];
    $fr05km = $registroPdf['kmForaRota5'];
    $fr05hora = $registroPdf['hrForaRota5'];
    $fr05deslocamento = $registroPdf['deslocForaRota5'];
    $fr05finalidade = $registroPdf['finalidadeForaRota5'];
    $fr05solicitante = $registroPdf['solicitanteForaRota5'];
    $fr06km = $registroPdf['kmForaRota6'];
    $fr06hora = $registroPdf['hrForaRota6'];
    $fr06deslocamento = $registroPdf['deslocForaRota6'];
    $fr06finalidade = $registroPdf['finalidadeForaRota6'];
    $fr06solicitante = $registroPdf['solicitanteForaRota6'];
    $getOcorrencia = $registroPdf['ocorrencia'];
}
$datasaida = formatoData($datasaida);
$dataretorno = formatoData($dataretorno);
$realdtsaida = formatoData($realdtsaida);
$realdtretorno = formatoData($realdtretorno);
...
$html = "<html>
           <body>
			...
			<tr>
                        <td align ='center'><FONT size = 8.0><p><u><b>SOLICITAÇÃO DE VEÍCULO Nº $numsolicitacao</b></u></p></td>
                        </tr>
                           ...
                           <td>
                             <table border = '0' width='100%' >
                                <tr>
                                   ...
                                   <td width='29%'><FONT size = 7.0><b>SIAPE</b></td>
                                   <td width='23%'><FONT size = 7.0><b>Telefone</b></td>
                                </tr>
                             </table>
                             <table border = '1' width='100%' cellspacing='0' >
                                 <tr>
                           ...
                           <td>
                             ...
                             <table border = '1' width='100%' cellspacing='0'>
                                 <tr align='center'>
                                   ...
                                   <td width='25%'><FONT size = 7.0>Recebimento $siglaSetorResp<br><br><br><br></td>
                         ...
                         <tr>
                           <td>
                             <table border = '0' width='100%' >
                                ...
                                <tr>
                                   <td width='100%'><FONT size = 5.3>O item 1 deverá ser preenchido pelo interessado no uso do serviço e encaminho à $siglaSetorResp;</td>
                                </tr>
                                  <tr>
                                   <td width='100%'><FONT size = 5.3>O item 2 será preenchido designando o motorista e autorizado pela $siglaSetorResp;</td>
                                </tr>
                                <tr>
...
<tr><td>&nbsp;</td></tr>
                       ...
                       <table border ='1' width='100%' cellspacing='1'>
                          <tr align='center'>
                               <td><FONT size = 9.0><b>PREENCHIMENTO E AUTORIZAÇÃO DA $siglaSetorResp</b></td>
                          </tr>
                       </table>
                      <table border ='0' width='100%' cellspacing='0'>
			  <tr><td>&nbsp;</td></tr>
                          ...
                          <tr>
                            <td>
                                <table border ='1' width='60%' cellspacing='1'>
                                   <tr>
                                       <td><FONT size = 7.0><b>&nbsp;&nbsp;</b>$motorista</td>
                                   </tr>
                                 </table>
                            </td>
                         </tr>   
		       ...
		       <table border = '1' width='100%' cellspacing='1'>
                         <tr align='center'>
                          ...
                          <tr align='center' >
                            ...
                            <td width='15%'><FONT size = 7.0>$kmsaida</td>
                            <td width='15%'><FONT size = 7.0>$realdtsaida</td>
                            <td width='15%'><FONT size = 7.0>$realhrsaida</td>
                            <td width='40%'><FONT size = 7.0>$plantonistasaida</td>
                         </tr>
                         <tr align='center'>
                            <td width='15%'><FONT size = 7.0> Retorno</td>
                            <td width='15%'><FONT size = 7.0>$kmretorno</td>
                            <td width='15%'><FONT size = 7.0>$realdtretorno</td>
                            <td width='15%'><FONT size = 7.0>$realhrretorno</td>
                            <td width='40%'><FONT size = 7.0>$plantonistaretorno</td>
                         </tr>
                       </table>
                       <table border = '0' width='100%' cellspacing='0'>
			 <tr><td>&nbsp;</td></tr>
                       ...
                       <table border = '1' width='100%' cellspacing='1'>
                         ...
                         <tr align='center'>
                            <td width='15%'><FONT size = 7.0>&nbsp;$fr01km</td>
                            <td width='14%'><FONT size = 7.0>$fr01hora</td>
                            <td width='15%'><FONT size = 7.0>$fr01deslocamento</td>
                            <td width='28%'><FONT size = 7.0>$fr01finalidade</td>
                            <td width='28%'><FONT size = 7.0>$fr01solicitante</td>
                         </tr>
                         <tr align='center'>
                            <td width='15%'><FONT size = 7.0>&nbsp;$fr02km</td>
                            <td width='14%'><FONT size = 7.0>$fr02hora</td>
                            <td width='15%'><FONT size = 7.0>$fr02deslocamento</td>
                            <td width='28%'><FONT size = 7.0>$fr02finalidade</td>
                            <td width='28%'><FONT size = 7.0>$fr02solicitante</td>
                         </tr>
                         <tr align='center'>
                            <td width='15%'><FONT size = 7.0>&nbsp;$fr03km</td>
                            <td width='14%'><FONT size = 7.0>$fr03hora</td>
                            <td width='15%'><FONT size = 7.0>$fr03deslocamento</td>
                            <td width='28%'><FONT size = 7.0>$fr03finalidade</td>
                            <td width='28%'><FONT size = 7.0>$fr03solicitante</td>
                         </tr>

                         <tr align='center'>
                            <td width='15%'><FONT size = 7.0>&nbsp;$fr04km</td>
                            <td width='14%'><FONT size = 7.0>$fr04hora</td>
                            <td width='15%'><FONT size = 7.0>$fr04deslocamento</td>
                            <td width='28%'><FONT size = 7.0>$fr04finalidade</td>
                            <td width='28%'><FONT size = 7.0>$fr04solicitante</td>
                         </tr>
                          <tr align='center'>
                            <td width='15%'><FONT size = 7.0>&nbsp;$fr05km</td>
                            <td width='14%'><FONT size = 7.0>$fr05hora</td>
                            <td width='15%'><FONT size = 7.0>$fr05deslocamento</td>
                            <td width='28%'><FONT size = 7.0>$fr05finalidade</td>
                            <td width='28%'><FONT size = 7.0>$fr05solicitante</td>
                         </tr>
                         <tr align='center'>
                            <td width='15%'><FONT size = 7.0>&nbsp;$fr06km</td>
                            <td width='14%'><FONT size = 7.0>$fr06hora</td>
                            <td width='15%'><FONT size = 7.0>$fr06deslocamento</td>
                            <td width='28%'><FONT size = 7.0>$fr06finalidade</td>
                            <td width='28%'><FONT size = 7.0>$fr06solicitante</td>
                         </tr>
                       ...
                       <table border ='0' width='100%' cellspacing='0'> 
                          <tr>
                               <td><FONT size = 7.0><br><b>Ocorrência</b><br>$getOcorrencia</td>
                          </tr>
                       </table>  
     </body>
</html>";
...
$dompdf->render();
$dompdf->stream("solicitacao finalizada número $numsolicitacao.pdf");
?>  
