            ...
            <div  class="container-fluid">    
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title" >Editar Marca de Veículo</h3>
                    </div>
                    <div class="panel-body "> 
                        <form method="post" action="editandoMarca.php" name="marc" id="marc">
                            <table class="table">
                                <tr >
                                    <td>
                                        <div >
                                        ...
                                        <input type="text" name="setCodMarca" style="color: brown;width: 50px"
                                               readonly="true" value="<?= $registro['idMarca'] ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                      ...
                                      <td>
                                        ...
                                        <input type="text" name="setMarca" 
                                               id="nome"value="<?= $registro['nomeMarca'] ?>"
