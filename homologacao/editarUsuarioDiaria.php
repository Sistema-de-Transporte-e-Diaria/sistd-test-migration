...
<html> 
    ...
    <body style="font-family: courier">
        ...
        $sqlUsuario = "SELECT * FROM listarsolicitantes
                                WHERE siape = $codUsuarioEditar";
            ...
            <div  class="container-fluid">    
                <div class="panel panel-success">
                    ...
                    <div class="panel-body "> 
                        <form method="post" action="editandoUsuarioSolicitante.php" name="usuario">
                            ...
                            <table class="table">
                                ...
                                <tr >
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="setCPF"  class="cpf"id="cpf"
                                               maxlength="14"value="<?= $registro['cpf'] ?>"
                          ...
                          ORDER BY nomeSetor";
                                    ...
                                    <td >
                                        ...
                                        <input type="email" name="setEmailUsuario" value="<?= $registro['email'] ?>"
                                               id="email"placeholder="email@exemplo.com" 
                                    ...
                                    <td>
                                        ...
                                        <input type="tel" name="setFoneUsuario"class="fone"id="tel" placeholder="(00)0000-0000"
                                               maxlength="15"value="<?= $registro['telefone'] ?>"
                                ...
                                <table class="table" hidden="true">
                                    ...
                                    if ($registro['administrador'] == "1") {
                                        ...
                                        <tr> 
                                            <td>
                                                <input type="radio" name="setNivelUsuario" value="1"class="form-group pull-right"
                                                       id="tipoNivel" checked="checked" hidden="true"/>
                                            </td>
                                            <td>
                                                <div> 
                                        ...
                                        if ($registro['administrador'] == "2") {
                                            ?>
                                            <td>
                                                <input type="radio" id="tipoNivel" class=" form-group pull-right"
                                        ...
                                        if ($registro['administrador'] == "3") {
                                            ...
                                            <td>
                                                <input type="radio" id="tipoNivel" class=" form-group pull-right" hidden="true"
                                            ...
                                            ?>                                
                                            <td>
                                                <input ttype="radio" id="tipoNivel" class=" form-group pull-right" hidden="true"
                                                       type="radio" name="setNivelUsuario" value="3"class="form-group pull-right"/>  
                                            </td>
                                            <td>
                                                <div>                                
                                        ...
                                        <?php }
                                        ?>    
                                        <?php if ($registro['administrador'] == "4") { ?>
                                            <td>
                                ...
                                <table class="table">
                                    ...
                                    if ($registro['administrador'] == "1") {
                                        ...
                                        if ($registro['administrador'] == "3") {
                                            ...
                                            ?>                                
                                            <td>
                                                <input ttype="radio" id="tipoNivel" class=" form-group pull-right"
                                                       type="radio" name="setNivelUsuario" value="3"class="form-group pull-right"/>  
                                            </td>
                                            <td>
                                                <div>                                
                            ...
                            <table class="table">   
                                ...
                                <tr>                                
                                    <td>
                                        ...
                                        <input type="text" name="setBanco" id="banco"value="<?= $registro['banco'] ?>"
                                               style="height: 100%;width: 200px" >
                                    </td>
                                    ...
                                    <td >
                                        ...
                                        <input type="text" name="setAgencia" id="ag"value="<?= $registro['agencia'] ?>"
                                               style="height: 100%;width: 200px" >
                                    </td>
                                    ...
                                    <td >
                                        ...
                                        <input type="text" name="setConta" id="cc"value="<?= $registro['conta'] ?>"
                                               style="height: 100%;width: 200px" >
                                    </td>
                                </tr>
                            </table> 
