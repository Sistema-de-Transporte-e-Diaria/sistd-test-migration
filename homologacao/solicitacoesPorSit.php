        ...
        <div  class="container-fluid">    
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title" >Relátorio de Solicitações por Situação</h3>
                </div>
                <div class="panel-body "> 
                    <form  method="post" action="relatorios/relSolicitacoesSit.php"target="_blank">  

                        <legend id="legendDadosPessoais" class="panel panel-success" 
                                style="background-color: #C1FFC1 "> Relatório com Filtro de Situação</legend> 
