...
<head>
<title>Solicitação de Transporte</title>
...
<div  class="container-fluid">
  <div class="panel panel-success">
    ...
    <div class="panel-body ">
      <form method="post" enctype="multipart/form-data" action="cadSolicita.php"
        name="solicita" onsubmit="return validaCampos();" >
        ...
        <table class="table">
          <tr>
            <td >
              ...
              <select  name="setEscolhaSolicitante" id="escolha" required="true" class="input-xxlarge" >
                <?php
                if ($admin == 1) {
                  //Captura o usuário logado para preencher os campos solicitante.
                  $l = $_SESSION['login_usuario'];
                  conecta();
                  $pesquisa = "SELECT * FROM solicitantes WHERE siape='$l' ";
                  ...
                  $l = $_SESSION['login_usuario'];
                  conecta();
                  $pesquisa = "SELECT * FROM solicitantes WHERE statusSolicitante <> 0 ORDER BY nome";
                  $resultado = mysql_query($pesquisa) or die("Não foi possível realizar a consulta ao banco de dados");
                  ?>
        ...
        <table class="table">
          <legend id="legendDadosViagem" class="panel panel-success" style="background-color:#C1FFC1">
            Dados Previstos da Viagem
          </legend>
          ...
          <tr>
            <td>
              ...
              <input name="prevDtSaida" type="text" id="calendario"
                style="height:100%" class="input-medium" required="true"/>
            </td>
            <td>
              <div>
                <label for="DataRetorno">Data</label>
              </div>
              <input type="text" id="calendario1" name="prevDtRetorno"
                class="input-medium" style=" height:100%"required="true"/>
            </td>
          </tr>
        ...
        <table class="table">
          ...
          <tr>
            <td >
              <div >
                <label for=" Destino/Itinerario" style="background-color:#d6e9c6 "class="input-xxxlarge">
                  Destino/Itinerário
                </label>
              </div>
            </td>
          ...
          <tr>
            <td>
              <textarea name="destino" type="text" maxlength="200" placeholder="Origem/Destino/Origem"
                class="input-xxlarge" id="destino" required="true" required="true" ></textarea>
            </td>
          </tr>
          ...
          <tr>
            <td>
              <textarea name="finalidade" type="text" maxlength="200" placeholder="Finalidade da viagem"
                class="input-xxlarge" id="just" required="true"></textarea>
            </td>
          </tr>
        </table>
        ...
        <table class="table ">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="foneOcup1" placeholder="(00)0000-0000"
          ...
          <tr>
            <td >2º
              <input type="text" name="ocupante2" class="input-large"style="height: 100%"/>
            </td>
            <td>
          ...
          <tr>
            <td >3º
              <input type="text" name="ocupante3" class="input-large"style="height: 100%"/>
            </td>
            <td>
          ...
          <tr>
            <td >4º
              <input type="text" name="ocupante4" class="input-large"style="height: 100%"/>
            </td>
            <td>
        ...
        <table class="table input-xxxlarge">
          <tr>
            <td >
              <div >
                <label for="obs">
                  OBS: Acima de 4 passageiros deve ser anexada a lista com NOME, SIAPE, Nº RG ou CPF.
                </label>
              </div>
            </td>
          </tr>
          <tr>
            <td>
              ...
              Enviar lista de passageiros:<br/>
              <input type="file" name="userfile" id="arquivo" class="arquivo">
              <input type="text" name="file" id="file"
                class="file" placeholder="Lista de Passageiros" readonly="readonly">
              <input type="button" class="butn" id="botao" value="SELECIONAR ARQUIVO">
            </td>
          </tr>
        </table>
