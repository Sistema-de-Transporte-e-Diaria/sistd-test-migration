        ...
        <div  class="container-fluid">    
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title" >Relátorio de Solicitações por Solicitante</h3>
                </div>
                <div class="panel-body "> 
                    <form  method="post" action="relatorios/relSolicitacoesSol.php"target="_blank">  

                        <legend id="legendDadosPessoais" class="panel panel-success" 
                                style="background-color: #C1FFC1 "> Relatório com Filtro de Solicitante</legend> 

                        <table class="table">
                            <tr>
                                <td>
                                    <div>
                                        <label for="SelecioneSolicitante"
                                               style="background-color: #d6e9c6">Selecione o Solicitante</label>
                                    </div>
                                </td>                                
                            </tr>
                            <tr>
                                <td>
                                    <select name="setEscolhaSolicitante" style="width: 500px">
                                        <option> </option>
                                        <?php
                                        conecta();
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td>
                                    <input name="status1" type="checkbox" value="1" checked="true" class=" form-group pull-right" />
                                </td>
                                <td>
                                    <div>
                                        <label for="Abertas">Abertas</label>
                                    </div>                                
                                </td>
                                <td>
                                ...
                                <td>
                                    <input name="status4" type="checkbox" value="4" checked="true" class=" form-group pull-right"/>
                                </td>
                                <td>
                                    <div>
                                        <label for="NaoAtendidas">Não Atendidas</label>
                                    </div>                               
                                </td>
                                <td>
                                    <input name="status5" type="checkbox" value="5" checked="true" class=" form-group pull-right"/>
                                </td>
                                <td>
                                    <div>
                                        <label for="ForaPrazo">Fora do Prazo</label>
                                    </div>                               
                                </td>
                            </tr>
                        </table>
