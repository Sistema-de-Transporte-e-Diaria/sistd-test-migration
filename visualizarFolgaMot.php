            ...
            <div  class="container-fluid">    
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title" >Visualizar Folga do Motorista</h3>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text"  id="calendario" value="<?= formatoData($registro['dataFolga']) ?>"
                                               name="setDataFolga" style="height: 100%" disabled="true"/>                             
                                    </td>
                                    <td >
                                        <div >
                                        ...
                                        <input type="text" name="setFolga" style="height: 30px;width: 150px" placeholder="00:00"
                                               disabled="true" maxlength="6" value="<?= $registro['quantHoraFolga'] ?>"/>
                                    </td>
                                </tr>
                            </table>
                            <table class="table">
                                <tr>               
                                    ...
                                    <td>
                                        ...
                                        <input  type="text" name="setJustificativa" disabled="true"
