...
$idSolicitacaoImprimir = $_GET['id'];
conecta();
$sqlPdf = "SELECT * FROM listarsolicitacao
            WHERE codSolicitacao = $idSolicitacaoImprimir";
...
// $horaDataSolicitacao = formatoData($horaDataSolicitacao);

$sqlCarro = "SELECT m.nomeMarca, v.modelo, v.placa 
              FROM veiculos v, marcas m, controle c 
              WHERE c.codSolicitacaoControle=$idSolicitacaoImprimir 
              AND v.codVeiculo=c.idVeiculo 
              AND m.idMarca = v.marca;";
$resCarro = mysql_query($sqlCarro);
while ($rowCarro = mysql_fetch_assoc($resCarro)) {
  $nomeMarca = $rowCarro['nomeMarca'];
  $modelo = $rowCarro['modelo'];
  $placa = $rowCarro['placa'];
}

$sqlMotorista = "SELECT m.motorista FROM motoristas m, controle c
                  WHERE c.codSolicitacaoControle=$idSolicitacaoImprimir AND c.idMotorista = m.codMotorista;";
$resMotorista = mysql_query($sqlMotorista);
while ($rowMotorista = mysql_fetch_assoc($resMotorista)) {
  $motorista = $rowMotorista['motorista'];
}
...
"<html>
  <body>
      ...
      <tr>
        <td>
          <table width='100%' border='0' align='center' cellspacing='0' cellpadding='0'>
            <tr align='center'>
              <td>
                <img src='imagens/imagem.jpg' width='100' heigth='90'>
              </td>
            </tr>
            <tr align='center'>
            ...
            <tr align='center'>
              <td><FONT size = 9.5><b>$nomeSetorResp</b></td>
			      ...
			      <tr>
              <td align ='center'>
                <FONT size = 8.0><p><u><b>SOLICITAÇÃO DE VEÍCULO Nº $numsolicitacao</b></u> Em: $data</p>
              </td>
            </tr>
          ...
          <table border = '0' width='100%' cellspacing='0'>
            <tr>
              <td>
                <table border = '0' width='100%' >
                  <tr>
                    <td width='25%' align='left'><FONT size = 7.0>
                      <b>&nbsp;&nbsp;Previsão Saída&nbsp;&nbsp;&nbsp;</b>
                    </td>
                    <td width='15%' align='left'><FONT size = 7.0>
                      <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hora</b>
                    </td>
            ...
            <tr>
              <td>
                <table border = '0' width='100%' >
                  <tr>
                    <td width='100%'><FONT size = 7.0>
                      <b>Destino Itinerário (Local de Saída e percurso a ser seguido)</b>
                    </td>
                  </tr>
                </table>
                <table border = '1' width='100%' cellspacing='0'>
              ...
              <td>
                <table border = '0' width='100%' >
                  <tr>
                    <td width='100%'><FONT size = 7.0>
                      <b>
                        OBS.: Acima de 4 Passageiros deve ser anexado a lista com NOME, SIAPE/MATRICULA, Nº do RG ou
                        CPF.
                      </b>
                    </td>
                  </tr>
            ...
            <tr>
              <td>
                <table border = '0' width='100%' >
                  ...
                  <tr>
                    <td width='100%'><FONT size = 5.3>
                      Para transporte a casa de divers&otilde;es, supermercados, estabelecimentos comerciais e de
                  ...
                  <tr>
                    ...
                    <tr>
                    <td width='100%'><FONT size = 5.3>
                      Aos sábados, domingos e feriados, salvo para desempenho de encargos inerentes ao serviço público;
                    </td>
                  </tr>
                  <tr>
                    <td width='100%'><FONT size = 5.3>
                      No transporte de familiares do servidor ou de pessoas estranhas ao serviçoo público e no translado
                      internacional de funcionários, ressalvados os casos previstos na alíneas b e c do artigo 3º e no
                      artigo 14, ambos do anexo do decreto nº 1.280 de 14 de outubro de 1994.
                    </td>
                  </tr>
                  <tr>
                    <td width='100%'><FONT size = 5.3>
                      Para deslocamento e vice-versa, em viagem o objeto de serviço, ressalvados aqueles deslocamentos
                      que não possam ser atendidos por meio regular de transporte, ou quando inexistir transporte
                      regular de qualquer outro meio ou, ainda, quando não perceber a ajuda de transporte de que trata
                      o artigo 9º do decreto nº 343 de 19 de novembro de 1991, devidamente autorizado pelo Coordenador
                      Geral de serviços gerais ou autoridade equivalente no órgão/entidade.
                    </td>
                  </tr>
                  <tr>
                    <td width='100%'><FONT size = 5.3>
                      É proibido o uso de placas não oficiais em veículos oficiais, bem como o de placas em veículos
                      particulares,ressalvados os casosprevistos na Lei nº 8.052, de 20/06/90.
                    </td>
                  </tr>
                  <tr>
                    <td width='100%'><FONT size = 5.3>
                      É vedada aos órgãos e entidades integrantes do SISG, a requisição de veíulos de empresas públicas
                      e sociedades de economia mista.
                    </td>
                  </tr>
                  <tr>
                    <td width='100%'><FONT size = 5.3>
                      É proibida a guarda de veículo oficial em garagem residencial, ressalvada o caso em que a garagem
                      oficial for situada a grande distância da residência de quem use o automóvel, condicionada à
                      autorização do respectivo Diretor Geral do Campus.
                    </td>
                  </tr>
                  <tr>
    ...
    <!----------------------- Segunda parte -------------------------->
    <table border='0' width='50%' style='float:right;'>
      <tr>
        <td>
          <table border='0' width='100%'>
            <tr>
              <td width='100%'>
                  ...
                  <tr>
                    <td>
                      <table border = '0' width='100%' >
                        ...
                        <tr>
                          <td width='100%'><FONT size = 5.3>
                            O item 1 deverá ser preenchido pelo interessado no uso do serviço e encaminho à
                            $siglaSetorResp;
                          </td>
                        </tr>
                        <tr>
                          <td width='100%'><FONT size = 5.3>
                            O item 2 será preenchido designando o motorista e autorizado pela $siglaSetorResp;
                          </td>
                        </tr>
                        <tr>
                          <td width='100%'><FONT size = 5.3>
                            O item 3 será repassado ao interessado no uso do serviço após o recebimento da solicitação
                            de veículo;
                          </td>
                        </tr>
                        <tr>
                          <td width='100%'><FONT size = 5.3>
                            Não nos responsabilizamos por pedidos sem tempo hábil para execução, de 48 horas.
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td width='100%'><FONT size = 5.3>
                            É obrigação do solicitante, manter a ordem no interior do transporte, zelando pelo
                            patrimônio público e bem como não permitir o uso de <br>drogas, bebidas alcoólicas e/ou
                            agentes prejudiciais à saúde dos passageiros;
                          </td>
                        </tr>
                        <tr>
                          <td width='100%'><FONT size = 5.3>
                            O motorista deverá comunicar à $siglaSetorResp sobre quaisquer infraç&otilde;es por parte
                            dos passageiros;
                          </td>
                        </tr>
                        <tr>
                          <td width='100%'><FONT size = 5.3>
                            O motorista deverá comunicar à $siglaSetorResp sobre quaisquer danos, por dolo e/ou culpa,
                            sofrido pelo veículo durante o uso;
                          </td>
                        </tr>
                        <tr>
                          <td width='100%'><FONT size = 5.3>
                            Não responsabilidade do motorista por pertences deixados após o desembarque dos passageiros.
                          </td>
                        </tr>
                      </table>
                    </td>
                ...
                <table  border ='0' width='100%' cellspacing=''>
                  ...
                  <tr align='center'>
                    ...
                    <td width ='40%'><FONT size = 7.0><br>Em,______/_______/_______</td>
			          ...
			          <table  border ='1' width='100%' cellspacing='1'>  
                  <tr>
                    <td><FONT size = 7.0><b>Placa</b></td>
                    <td><FONT size = 7.0><b>Veiculo</b></td>
                    <td><FONT size = 7.0><b>Combustível</b></td>
                  </tr>

                  <tr align='center'>
                    <td><FONT size = 7.0> $placa </td>
                    <td ><FONT size = 7.0> $nomeMarca $modelo </td>
                    <td ><FONT size = 7.0> <u>__0/0________1/4________1/2________3/4________1/1__</u> </td>
			            </tr>
                </table>
                ...
                <table border='0'>
                  ...
                  <tr align='right'>
                    <td><FONT size = 9.0>
                      <b>ATENÇÃO - VERIFICAR NA SAÍDA: Óleo  -  Água  -  Freios  -  Pneus  -  Sinalização(luzes)</b>
                    </td>
                  </tr>
                  <tr><td>&nbsp;</td></tr>
                </table>
                ...
                <table border = '0' width='100%' cellspacing='0'>
			            <tr><td>&nbsp;</td></tr>
                  <tr>
                    <td valign='middle'><FONT size = 8.5 >
                      <b>Todos deslocamentos fora da rota de percurso deverá ser informado de acordo com a planilha
                      abaixo:</b>
                    </td>
                  </tr>
                </table>
