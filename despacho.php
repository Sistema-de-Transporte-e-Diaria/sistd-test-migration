        ...
        <table class="table">
            ...
            <td>
              ...
              <select name="setSolicit" id="solicit"required="true" class="input-xxlarge">
                ...
                while ($row1 = mysql_fetch_assoc($res1)) {
                  echo '<option value="' . $row1['codSolicitacao'] . '">' .
                          $row1['codSolicitacao'] . '-' . $row1['nome'] .
                        '</option>';
                }
                ?>
              </select>
          ...
          <tr>
            <td>
              ...
              <textarea name="setJust" type="text" maxlength="250"
                required="true" class="input-xxlarge" id="setJust">
              </textarea>
            </td>
          </tr>
        </table>
